...
// General Block
  ...
  mainLabel = createDiv('<div style="color:#FFFFFF"> <a href=https://cskonopka.github.io/p5js/ style="color:#FFFFFF"; text-align:center;><h3>square playground ~ christopher konopka</h3></div>');
...
// Global Waveform Selector
  ...
  waveform = waveformMASTER[0].waveform[3];
